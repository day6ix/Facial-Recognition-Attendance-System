...
2. Enter basic info and create a student record.

3. Capture Faces

4. Capture multiple face images via webcam for training.

5. Train Model

6. Train the recognition model on collected images.

7. Mark Attendance

8. Use webcam to detect and recognize faces and log attendance.
```
***🧩 How It Works***
---
